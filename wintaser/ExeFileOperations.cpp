...
unsigned int GetWin32ExeDefaultStackSize(char *exefile)
{
    ...
    unsigned int defaultStackSizeOffset = peHeaderOffset + 0x60; // 0x60 is the offset from the PE-header start to where the default stack size is stored by the linker in the PE header
