...
namespace Config
{
    ...
    int Load_Config(const char* filename)
    {
        ...
        localTASflags.debugPrintMode = static_cast<DebugPrintModeMask>(GetPrivateProfileIntA("Debug", "Debug Logging Mode", static_cast<int>(localTASflags.debugPrintMode), Conf_File));
